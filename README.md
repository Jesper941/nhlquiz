...
- If you end up with a score of 3 or lower, you get the following message. (assets/images/low-score.png)
- If you end up with a score of 4 and 6, you get the following message. (assets/images/mid-score.png)
- If you end up with a score of 7 or higher, you get the following message. (assets/images/high-score.png)

- If you press the "Replay" button by the end of the quiz, you get taken straight back to the first question of the next quiz. (assets/images/replay.png)
